                    ...
                    <div class="col-12">
                        ...
                        <div class="bg-light rounded h-100 p-4">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                ...
                                <a href="{{ route('admin.roles.create') }}" class="btn btn-info rounded-pill">Agregar Nuevo Rol</a>
                            </div>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.roles.edit', $role) }}" class="btn btn-square btn-outline-warning"><i class="bi bi-pencil-fill"></i></a>
                                              <form action="{{ route('admin.roles.destroy', ['role' => $role->id]) }}" method="POST" style="display:inline-block;">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" onclick="return confirm('¿Estás seguro de eliminar este rol?')" class="btn btn-square btn-outline-danger"><i class="bi bi-x-circle-fill"></i></button>
                                            </form>
                                            </td>

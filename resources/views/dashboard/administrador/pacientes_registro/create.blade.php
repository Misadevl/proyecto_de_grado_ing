            ...
            <div class="sidebar pe-4 pb-3">
                <nav class="navbar bg-light navbar-light">
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <a href="{{ route('admin.patients.index') }}" class="nav-item nav-link"><i
                                class="fa fa-keyboard me-2"></i>Pacientes</a>
                        ...
                        <div class="col-md-8">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="mb-0">Completar Registro del Paciente</h5>
                                </div>
                                    ...
                                    <form action="{{ route('admin.patients.store') }}" method="POST">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control " id="second_surname"
                                                name="second_surname" value="{{ old('second_surname') }}"
                                                placeholder="Opcional">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" id="gender" name="gender">
                                                ...
                                                <option value="male"
                                                    {{ old('gender') == 'male' ? 'selected' : '' }}>Masculino</option>
                                                <option value="female"
                                                    {{ old('gender') == 'female' ? 'selected' : '' }}>Femenino</option>
                                            </select>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="phone" name="phone"
                                                value="{{ old('phone') }}" placeholder="Ingrese el teléfono">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            {{-- <select class="form-control" id="state_civil" name="state_civil">
                                            <option value="">Seleccione...</option>
                                            <option value="soltero" {{ old('state_civil') == 'soltero' ? 'selected' : '' }}>Soltero</option>
                                            <option value="casado" {{ old('state_civil') == 'casado' ? 'selected' : '' }}>Casado</option>
                                            <option value="divorciado" {{ old('state_civil') == 'divorciado' ? 'selected' : '' }}>Divorciado</option>
                                        </select> --}}
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="additional_notes" name="additional_notes" placeholder="Ingrese notas relevantes">{{ old('additional_notes') }}</textarea>

                                        </div>

                                </div>
                                <div class="form-group"> <label for="password">Contraseña</label> <input
                                        type="password" name="password" class="form-control" required> </div>
                                <div class="form-group">
                                    <label for="password_confirmation">Confirmar Contraseña</label> <input
                                        type="password" name="password_confirmation" class="form-control" required>
                                </div>
                                <!-- Botones -->

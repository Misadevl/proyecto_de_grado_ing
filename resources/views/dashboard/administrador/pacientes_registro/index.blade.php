        ...
        <div class="col-12">
            <div class="bg-light rounded p-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="{{ route('admin.patients.create') }}" class="btn btn-info rounded-pill">Crear Paciente</a>
                </div>
                @if(session('success'))
                        ...
                        @forelse($patients as $patient)
                            <tr>
                              ...
                              {{--   <td>{{ $patient->gender }}</td> --}}
                                <td>
                                    {{-- <a href="{{ route('admin.patients.show', $patient) }}" class="btn btn-info btn-sm">Ver</a> --}}
                                    <a href="{{ route('admin.patients.edit', $patient) }}" class="btn btn-square btn-outline-warning"><i
                                        class="bi bi-pencil-fill"></i></a>
                                    <form action="{{ route('admin.patients.destroy', $patient) }}" method="POST" style="display: inline-block;">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-square btn-outline-danger" onclick="return confirm('¿Está seguro de eliminar este paciente?')"><i
